...
function addSearchForm() {
  ...
  if (menu) {
    ...
    GM_addStyle('\
      ...
      #menu form input[name="q"]{height:30px;border:1px solid #ccc}\
      #menu form input[type="submit"]{\
      height:32px;text-align:center;color:#fff;font-weight:bold;\
      text-shadow:0 1px 0 rgba(0, 32, 0, .8);\
      background-image:-moz-linear-gradient(top,#57d100 25%,#008700);\
      background-image:-o-linear-gradient(top,#57d100 25%,#008700);\
      background-image:-webkit-linear-gradient(top,#57d100 25%,#008700);\
      background-image:linear-gradient(to bottom,#57d100 25%,#008700);\
      border:none}\
      #menu form input[type="submit"]:hover{\
      background-image:-moz-linear-gradient(top,#57d100 50%,#008700)\
      background-image:-o-linear-gradient(top,#57d100 50%,#008700)\
      background-image:-webkit-linear-gradient(top,#57d100 50%,#008700)\
      background-image:linear-gradient(to bottom,#57d100 50%,#008700)\
    }');
